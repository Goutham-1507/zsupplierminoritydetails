		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Supplier Minority Details",
									"targetURL": "#zsupplierminoritydetails-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zsupplierminoritydetails-display": {
								"semanticObject": "zsupplierminoritydetails",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zsupplierminoritydetails",
									"url": sap.ui.require.toUrl("zsupplierminoritydetails")
								}
							}
						}
					}
